...
public class DatabaseManager {
    ...
    public int addCourse(Course course) throws SQLException {
        String sql = "INSERT INTO courses (name, code, description) VALUES (?, ?, ?)";
    ...
    public void updateCourse(Course course) throws SQLException {
        String sql = "UPDATE courses SET name = ?, code = ?, description = ? WHERE id = ?";
    ...
    public List<Topic> getTopicsByCourse(int courseId) throws SQLException {
        ...
        String sql = "SELECT * FROM topics WHERE course_id = ? ORDER BY priority DESC, name";
    ...
    public List<ExamSchedule> getExamsByCourse(int courseId) throws SQLException {
        List<ExamSchedule> exams = new ArrayList<>();
        String sql = "SELECT * FROM exam_schedules WHERE course_id = ? ORDER BY exam_date";
    ...
    private ExamSchedule extractExamFromResultSet(ResultSet rs) throws SQLException {
    ...
    public int addStudySession(StudySession session) throws SQLException {
        ...
        try (PreparedStatement pstmt = connection.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS)) {
            ...
            pstmt.setObject(7, session.getPerformanceRating() > 0 ? session.getPerformanceRating() : null);
    ...
    public List<StudySession> getSessionsByDate(LocalDate date) throws SQLException {
        ...
        try (PreparedStatement pstmt = connection.prepareStatement(sql)) {
            ...
            while (rs.next()) {
                ...
                session.setCourseName(rs.getString("course_code") + " - " + rs.getString("course_name"));
    ...
    private StudySession extractSessionFromResultSet(ResultSet rs) throws SQLException {
