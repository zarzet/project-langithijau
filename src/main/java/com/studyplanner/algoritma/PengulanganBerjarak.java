...
public class PengulanganBerjarak {
    ...
    private static final AlgoritmaFSRS FSRS = new AlgoritmaFSRS();

    public static LocalDate hitungTanggalUlasanBerikutnya(Topik topik, int ratingPerforma) {
        int ratingFsrs = AlgoritmaFSRS.petaRatingPenggunaKeFsrs(ratingPerforma);
        AlgoritmaFSRS.KondisiMemori kondisi = ambilKondisi(topik);
        ...
        AlgoritmaFSRS.OpsiInterval opsi = FSRS.hitungKeadaanBerikutnya(
                kondisi,
                targetRetensi(topik),
                hariSejakUlasan);
        ...
        topik.setStabilitasFsrs(hasil.getKondisiMemori().getStabilitas());
        topik.setKesulitanFsrs(hasil.getKondisiMemori().getKesulitan());
    ...
    private static AlgoritmaFSRS.KondisiMemori ambilKondisi(Topik topik) {
